          ...
          <Grid container spacing={2} key={index}>
            <Grid item xs={7}>
              <TextField
                ...
                onChange={event =>
                  handleIngredientInputChange(event, 'name', index)
                }
            ...
            <Grid item xs={2}>
              <TextField
                ...
                onChange={event =>
                  handleIngredientInputChange(event, 'quantity', index)
                }
            ...
            <Grid item xs={2}>
              <FormControl variant="outlined" fullWidth margin="normal">
                ...
                <Select
                  ...
                  onChange={event =>
                    handleIngredientInputChange(event, 'unitOfMeasure', index)
                  }
                  labelWidth={115}
                >
            ...
            {index !== 0 ? (
              <Grid item xs={1}>
                <button
                  onClick={event => handleRemoveIngredientRow(event, index)}
                  className="remove"
                >
                  -
                </button>
